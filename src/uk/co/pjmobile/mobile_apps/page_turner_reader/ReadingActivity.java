...
import pageturner.Configuration;
...
import uk.co.pjmobile.mobile_apps.page_turner_reader.view.AnimatedImageView;
import uk.co.pjmobile.mobile_apps.page_turner_reader.view.BookView;
import uk.co.pjmobile.mobile_apps.page_turner_reader.view.NavGestureDetector;
...
import animation.PageCurlAnimator;
import animation.PageTimer;
import animation.RollingBlindAnimator;

import com.google.inject.Inject;

public class ReadingActivity extends RoboActivity implements uk.co.pjmobile.mobile_apps.page_turner_reader.view.BookViewListener {
...
//	@InjectView(value="mainContainer")
...
//	private AlertDialog tocDialog;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.gestureDetector = new GestureDetector(this, new NavGestureDetector(
...
//		@InjectView(R.id.myTitleBarTextView)
		titleBar = (TextView) findViewById(R.id.myTitleBarTextView);

//		@InjectView(R.id.myTitleBarLayout)
		titleBarLayout = (RelativeLayout) findViewById(R.id.myTitleBarLayout);

//		@InjectView(R.id.titleProgress)
		progressBar = (SeekBar) findViewById(R.id.titleProgress);

//		@InjectView(R.id.percentageField)
		percentageField = (TextView) findViewById(R.id.percentageField);

//		@InjectView(R.id.authorField)
		authorField = (TextView) findViewById(R.id.authorField);
...
//		new DownloadProgressTask().execute();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (itemId == R.id.profile_night){
			...
			return true;
		}else if (itemId == R.id.profile_day){
...
//			launchLibrary();
			Util.toast(this, "Should launch library");
			return true;**/
