...
public class LibraryDatabaseHelper extends SQLiteOpenHelper {
	...
	public boolean hasBook(String fileName) {
		...
		Cursor findBook = getDataBase().query("lib_books",
	...
	public KeyedQueryResult<LibraryBook> findByField(Field fieldName,
			String fieldValue, Field orderField, Order ordering) {
		...
		Cursor cursor = getDataBase().query("lib_books",
	...
	public QueryResult<LibraryBook> findAllOrderedBy(Field fieldName,
			Order order) {

		Cursor cursor = getDataBase().query(
				"lib_books",
				fieldsAsString(Field.values()),
				fieldName != null ? fieldName.toString() + " is not null"
						: null,
				new String[0],
				null,
				null,
	...
	public KeyedQueryResult<LibraryBook> findAllKeyedBy(Field fieldName,
			Order order) {
