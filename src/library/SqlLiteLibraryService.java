...
import library.LibraryDatabaseHelper.Order;
...
public class SqlLiteLibraryService implements LibraryService {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(SqlLiteLibraryService.class);
	...
	public void storeBook(String fileName, Book book, boolean updateLastRead,
		...
		if (copyFile) {
			bookFile = copyToLibrary(fileName, authorLastName + ", "
	...
	private File copyToLibrary(String fileName, String author, String title)
			throws IOException {

		File baseFile = new File(fileName);

		File targetFolder = new File(BASE_LIB_PATH + cleanUp(author) + "/"
				+ cleanUp(title));
	...
	public LibraryBook getBook(String fileName) {
		QueryResult<LibraryBook> booksByFile = helper.findByField(
				LibraryDatabaseHelper.Field.file_name, fileName, null,
				Order.ASC);
